...
const COMUM = [
  {
    ...
    alternativas: [
      { id: 'a', texto: 'Entreguei o relatório à os escrivães.' },
  ...
  },
  {
    ...
    tipo: 'fechada',
    enunciado:
      'A Polícia Federal exerce, entre outras, a função de polícia judiciária da União. Isso significa que ela atua principalmente:',
    alternativas: [
      ...
      { id: 'c', texto: 'na fiscalização de tributos municipais' },
      { id: 'd', texto: 'na administração dos presídios federais' },
...
const ESCRIVAO = [
  {
    id: 'es-01',
    area: 'Direito e Processo Penal',
    tipo: 'fechada',
    enunciado: 'No auto de prisão em flagrante, cabe ao escrivão de polícia:',
    alternativas: [
      { id: 'a', texto: 'decretar a prisão preventiva do conduzido' },
      { id: 'b', texto: 'reduzir a termo as declarações e lavrar o auto, garantindo a formalização do ato' },
      { id: 'c', texto: 'definir a pena aplicável ao crime' },
      { id: 'd', texto: 'julgar a legalidade da prisão' },
      { id: 'e', texto: 'dispensar a presença de testemunhas' },
    ],
    gabarito: 'b',
    pontos: 1,
  },
  {
    ...
    area: 'Direito e Processo Penal',
    tipo: 'fechada',
    enunciado: 'Os atos lavrados pelo escrivão de polícia gozam de fé pública. Isso significa que:',
    alternativas: [
      { id: 'a', texto: 'não podem jamais ser questionados' },
      { id: 'b', texto: 'presumem-se verdadeiros até prova em contrário' },
      { id: 'c', texto: 'têm valor de sentença judicial' },
      { id: 'd', texto: 'dispensam a assinatura da autoridade policial' },
      { id: 'e', texto: 'só valem se registrados em cartório extrajudicial' },
    ],
    gabarito: 'b',
    pontos: 1,
  },
  {
    ...
    tipo: 'fechada',
    enunciado:
      'Em um cartório policial, os inquéritos são autuados seguindo a sequência 3, 6, 11, 18, 27, ... Qual é o próximo número da sequência?',
    alternativas: [
      { id: 'a', texto: '34' },
      { id: 'b', texto: '36' },
      { id: 'c', texto: '38' },
  ...
  },
  {
    ...
    area: 'Direito e Processo Penal',
    tipo: 'fechada',
    enunciado: 'Ao formalizar o depoimento de uma testemunha durante o inquérito, o documento produzido pelo escrivão denomina-se:',
    alternativas: [
      { id: 'a', texto: 'sentença' },
      { id: 'b', texto: 'termo de declarações' },
      { id: 'c', texto: 'denúncia' },
      { id: 'd', texto: 'acórdão' },
      { id: 'e', texto: 'habeas corpus' },
    ],
    gabarito: 'b',
    pontos: 1,
  },
